...
$pesan = mysql_query("SELECT * FROM comment_status WHERE baca='belum' and untuk='$nim'");
...
<?php	
    ...
    die("<font color=red size=1>Tidak ada notifikasi yang belum dilihat</font>");
}
while($p = mysql_fetch_array($pesan)){
$pes=substr($p[6],0,20);
$qry_mhs=mysql_query("select * from mahasiswa where nim='$p[2]'");
